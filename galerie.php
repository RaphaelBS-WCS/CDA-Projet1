    ...
    <section class="galerie col-md-11 col-xl-10 mx-auto">
        ...
        <div class="slider-for" id="slideshow">
			<div class="item container-fluid mx-auto">
					...
					<p class="d-block mw-100 mx-auto text-center border border-3 rounded text-secondary">L'imposante cathédrale Sainte-Croix fut construite par Henri IV, sur les ruines des cathédrales précédentes.</p>
			</div>
			<div class="item container-fluid mx-auto">
					...
					<p class="d-block mw-100 mx-auto text-center border border-3 rounded  text-secondary">Si vous aimez vous promener au bord de l'eau, rejoignez les bords de Loire. Vous pourrez faire une balade à pied ou à vélo.</p>
            ...
            <div class="item container-fluid mx-auto">
					...
					<p class="d-block mw-100 mx-auto text-center border border-3 rounded text-secondary">Le Parc Floral de La Source est labellisé « Jardin remarquable » pour ses 950 variétés d’iris classées « Collection nationale » mais aussi pour sa roseraie et son potager.</p>
            ...
            <div class="item container-fluid mx-auto">
					...
					<p class="d-block mw-100 mx-auto text-center border border-3 rounded text-secondary">Le Frac Centre-Val de Loire est une collection publique d'art contemporain dont l'espace d'exposition est situé à Orléans.</p>
            </div>
            ...
            <div class="item container-fluid mx-auto">
					...
					<p class="d-block mw-100 mx-auto text-center border border-3 rounded  text-secondary">La statue équestre de Jeanne d'Arc, place du Martroi à Orléans est une œuvre de Denis Foyatier datant de 1855.</p>
            ...
            <div class="item container-fluid mx-auto">
					...
					<p class="d-block mw-100 mx-auto text-center border border-3 rounded text-secondary"> La gare d'Orléans est une gare ferroviaire française située sur le territoire de la commune d'Orléans, dans le département du Loiret, en région Centre-Val de Loire.</p>
            ...
            <div class="item container-fluid mx-auto">
					...
					<p class="d-block mw-100 mx-auto text-center border border-3 rounded text-secondary"> Durant tout l’été, venez assister au spectacle son & lumière sur la cathédrale Sainte-Croix d’Orléans !</p>
